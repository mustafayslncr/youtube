    ...
    return (
        <div className="header">
            ...
            <div className="header-orta">
                ...
                <span style={{display:'flex',justifyContent:'center',color:'gray',marginLeft:'7px',cursor:'pointer'}}><MicIcon/></span>
                   
           </div>
           <div className="header-sag">
                <span style={{display:'flex',justifyContent:'center',marginRight:'7px',cursor:'pointer'}} ><AppsIcon/></span>

                <span style={{display:'flex',justifyContent:'center',marginRight:'7px',cursor:'pointer'}}><MoreVertIcon/></span> 
